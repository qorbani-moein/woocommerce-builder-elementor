...
class DTWCBE_Single_Product_Image_Widget_moein extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'moein-single-product-images';
	}
	...
	public function get_title() {
		return esc_html__( 'تصویر ووکامرس(معین)', 'woocommerce-builder-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'woocommerce', 'shop', 'store', 'image', 'product', 'gallery', 'lightbox','معین' ];
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new DTWCBE_Single_Product_Image_Widget_moein());